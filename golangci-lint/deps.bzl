...
def golangci_lint_dependencies():
    http_archive(
        ...
        urls = ["https://github.com/golangci/golangci-lint/releases/download/v1.57.1/golangci-lint-1.57.1-linux-amd64.tar.gz"],
        ...
        strip_prefix = "golangci-lint-1.57.1-linux-amd64",
    )
    http_archive(
