...
def golangci_lint_dependencies():
    ...
    http_archive(
        ...
        urls = ["https://github.com/golangci/golangci-lint/releases/download/v1.57.0/golangci-lint-1.57.0-darwin-amd64.tar.gz"],
        sha256 = "ffe00008593859452c2b460ca7491b40bf979c64ebb9597aa7da2ab17c48cf96",
        build_file = "@com_github_danmx_bazel_tools//golangci-lint:golangci-lint.BUILD",
        strip_prefix = "golangci-lint-1.57.0-darwin-amd64",
    )
    http_archive(
